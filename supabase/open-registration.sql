-- Wellness Lab — Open registration (run once in Supabase SQL Editor)
-- Removes invite-only signup. Anyone can register; customers are approved immediately to shop.
